...
xref:bamm-specification:appendix:bibliography.adoc#rec20[[rec20\]] and comprises about 1,800 units. The
...
xref:bamm-specification:appendix:bibliography.adoc#rec20[original specification] for more details |
