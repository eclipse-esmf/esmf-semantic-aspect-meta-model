...
| `samm-c:integer` | The number of integral digits for a fixed point number. E.g. if a fixedpoint number is 123.04, the scaling factor is 3 (the number of digits before the decimal point). Must be given as
  `xsd:positiveInteger`. | {ok}
|===
