...
xref:bamm-specification:appendix:bibliography.adoc#bcp47[[bcp47\]], for example "de-DE".
...
xref:bamm-specification:appendix:bibliography.adoc#iso639[[iso639\]], for example "de".
...
xref:bamm-specification:appendix:bibliography.adoc#rfc2046[[rfc2046\]], for example "application/json",
...
| `bamm-c:languageCode` | An ISO 639-1
  xref:bamm-specification:appendix:bibliography.adoc#iso639[[iso639\]] language code for the language of
...
|===
| Attributes | Description | Required
| `bamm-c:localeCode` | An IETF BCP 47 xref:bamm-specification:appendix:bibliography.adoc#bcp47[[bcp47\]]
...
[.element-urn]
--
{bamm-c}RegularExpressionConstraint
--

Restricts a string value to a regular expression as defined by XQuery 1.0 and XPath 2.0 Functions
and Operators xref:bamm-specification:appendix:bibliography.adoc#xpath-functions[[xpath-functions\]].
