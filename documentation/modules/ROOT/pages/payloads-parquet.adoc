...
We need to analyze this issue in detail and create a bug report in the ESMF project.
In the meantime, we will represent String as BYTE_ARRAY until this ESMF issue is resolved.
