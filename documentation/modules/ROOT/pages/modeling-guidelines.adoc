...
by using separate xref:modeling-guidelines.adoc#declaring-properties[Properties] or an xref:characteristics.adoc#either-characteristic[Either] Characteristic.
