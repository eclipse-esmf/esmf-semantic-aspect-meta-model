...
xref:characteristics.adoc#reference-characteristic[Reference] are intended to be used
for scenarios where you need to create a unique property that can link to external
or internal elements in a flexible and versatile manner.
