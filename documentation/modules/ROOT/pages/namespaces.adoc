...
xref:bamm-specification:appendix:bibliography.adoc#rfc2141[[rfc2141\]] and the following schema:
...
xref:bamm-specification:appendix:bibliography.adoc#curie[[curie\]]), i.e., the shortening of URIs by
pre-defining a short name for common parts of URIs in a local context (in particular, XML namespaces
xref:bamm-specification:appendix:bibliography.adoc#xmlns[[xmlns\]],
https://www.w3.org/TR/turtle/#sec-iri[@prefix] in RDF/Turtle
xref:bamm-specification:appendix:bibliography.adoc#turtle[[turtle\]] and
https://www.w3.org/TR/sparql11-query/#QSynIRI[PREFIX] in SPARQL
xref:bamm-specification:appendix:bibliography.adoc#sparql[[sparql\]]):
