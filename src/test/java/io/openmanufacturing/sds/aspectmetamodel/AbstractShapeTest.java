...
public abstract class AbstractShapeTest {
   ...
   final String MESSAGE_INVALID_ENTRY_ASPECT_PROPERTY_LIST = "Each element in the Aspect's properties list must be either a Property or a blank node "
         + "referring to a Property and defining bamm:optional \\\"true\\\"^^xsd:boolean and/or bamm:payloadName.";
   final String MESSAGE_INVALID_ENTRY_ENTITY_PROPERTY_LIST = "Each element in the Entity's properties list must be either a Property or a blank node "
         + "referring to a Property and defining either bamm:optional \\\"true\\\"^^xsd:boolean and/or bamm:payloadName or bamm:notInPayload "
         + "\\\"true\\\"^^xsd:boolean.";
   final String MESSAGE_INVALID_ENTITY_PROPERTY_DEFINITION = "A Property of an Entity may not be defined with both bamm:optional \\\"true\\\"^^xsd:boolean "
         + "and bamm:notInPayload \\\"true\\\"^^xsd:boolean.";
   final String MESSAGE_INVALID_ENTITY_PROPERTY_PAYLOAD_NAME = "A Property of an Entity may not be defined with both bamm:payloadName and bamm:notInPayload "
         + "\\\"true\\\"^^xsd:boolean.";
   final String MESSAGE_ENTITY_NOT_USED_IN_ENUMERATION = "A Property of an Entity may only be defined with bamm:notInPayload \\\"true\\\"^^xsd:boolean when "
         + "the Entity, or one of its parent Entities, is used as the data type of an Enumeration.";
   final String MESSAGE_INVALID_ENTITY_WITH_SINGLE_PROPERTY = "An Entity defining a Property with bamm:notInPayload \\\"true\\\"^^xsd:boolean must define at "
   ...
   final String MESSAGE_EQUAL_CHARACTERISTICS = "The Characteristic referenced by the bamm-c:left and bamm-c:right attributes of the Either Characteristic "
         + "(see focus node) may not be equivalent.";
   ...
   final String MESSAGE_ELEMENTS_MUST_HAVE_SCALAR_TYPE = "Properties referred to in StructuredValue's elements must have a Characteristic with a scalar "
         + "dataType";
   final String MESSAGE_ELEMENTS_HAVE_INVALID_CHARACTERISTIC = "This Characteristic may not be used with Properties that appear as elements in a "
         + "StructuredValue";
   ...
   final String MESSAGE_INSTANCE_INVALID_TYPE_CONTAINED_IN_LIST = "The value for a list Property of the Entity instance contains an entry with an invalid "
         + "data type.";
   final String MESSAGE_COLLECTION_WITHOUT_DATA_TYPE = "A Collection must be defined with either a bamm:dataType or a bamm-c:elementCharacteristic (see "
         + "focusNode).";
