...
public class AbstractEntityShapeTest extends AbstractShapeTest {
   ...
   public void testAmbiguousEntitiesDueToPropertyNamesExpectFailure( final KnownVersion metaModelVersion ) {
      ...
      SemanticError resultForAmbiguousEntityA = new SemanticError(
            "The Entity :A contains a Property with name a which causes ambiguity in combination with the :B Entity.",
            TEST_NAMESPACE_PREFIX + "A", "", VIOLATION_URN, "a" );
      SemanticError resultForAmbiguousEntityB = new SemanticError(
            "The Entity :B contains a Property with name a which causes ambiguity in combination with the :A Entity.",
      ...
      resultForAmbiguousEntityA = new SemanticError(
            "The Entity :A contains a Property with name abstractString which causes ambiguity in combination with the :AbstractTestEntityWithPayloadNameEqualToExtendingEntityProperty Entity.",
      ...
      resultForAmbiguousEntityA = new SemanticError(
            "The Entity :A contains a Property with name same which causes ambiguity in combination with the :B Entity.",
            TEST_NAMESPACE_PREFIX + "A", "", VIOLATION_URN, "same" );
      resultForAmbiguousEntityB = new SemanticError(
            "The Entity :B contains a Property with name same which causes ambiguity in combination with the :A Entity.",
   ...
   public void testAmbiguousEntitiesDueToOptionalPropertyCombinationsExpectFailure( final KnownVersion metaModelVersion ) {
      ...
      SemanticError resultForAmbiguousExtendingEntity = new SemanticError(
            "The Entity :ExtendingEntity contains a Property with name abstractOptionalProperty which causes ambiguity in combination with the :AbstractTestEntityWithOptionalPropertyAndExtendingEntityWithSameProperty Entity.",
   ...
   public void testAbstractEntityIsNotExtendedExpectFailure( final KnownVersion metaModelVersion ) {
      final SemanticError result = new SemanticError(
            "The Abstract Entity :AbstractTestEntity which is used as the data-type for AbstractEntity has not been extended.",
