...
Special Characteristic class that constrains another Characteristic in some way, e.g., the
...
|===
| Attributes | Description | Required
| `bamm:baseCharacteristic` | Reference to the Characteristic on which the Constraint is being
  applied | {ok}
|===
