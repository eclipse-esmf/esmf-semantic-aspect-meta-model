...
....
urn:bamm:org.open-manufacturing.digitaltwin:<element-type>:<version>#<element-name>
....
...
** `characteristic` - For Characteristics that are defined in the scope of the meta model
