...
of the Characteristic with the corresponding Constraint instance while at the same time setting the
Constraint's `baseCharacteristic` to the original Characteristic:
