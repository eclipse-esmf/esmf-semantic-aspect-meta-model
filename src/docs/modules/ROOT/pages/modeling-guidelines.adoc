...
* As mentioned in the xref:index.adoc[Introduction], Aspect models are described in RDF Turtle
  xref:bamm-specification:appendix:bibliography.adoc#turtle[[turtle\]]. The aspect specification will
...
xref:bamm-specification:appendix:bibliography.adoc#doi[[DOI\]]) `10.1109/NetSys.2017.7903949`, you can
...
xref:bamm-specification:appendix:bibliography.adoc#rfc3061[[rfc3061\]], so for example, for the OID
