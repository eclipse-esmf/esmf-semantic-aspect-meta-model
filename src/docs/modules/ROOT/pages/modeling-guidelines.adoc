...
its value is also inherited by the extending Entities. Using the example of `bamm:payloadName`,
...
by its children when using the Entity extension mechanism (`bamm::extends`).
