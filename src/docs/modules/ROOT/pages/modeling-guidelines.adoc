...
Please see the xref:modeling-guidelines.adoc#_declaring_abstract_entities[Declaring Abstract Entities] section for
...
Declaring that an Entity extends another Entity may be done using the `bamm:extends` attribute in the Entity declaration.
