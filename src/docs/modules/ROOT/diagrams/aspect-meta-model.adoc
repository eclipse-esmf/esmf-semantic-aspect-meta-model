...
include::diagram-style.dot[]
  ...
  Trait [label="{ «Trait»}", pos="4.5,-0.07!"]
  Constraint [label="{ «Constraint»}", pos="4.5,0.7!"]
  Characteristic [label="{ «Characteristic»|name : string\lpreferredName : langString [0..n]\ldescription : langString [0..n]\lsee : anyURI [0..n]\ldataType : \<type\>\l}", pos="4.5,-1.6!"]
  Quantifiable [label="{ «Quantifiable»}", pos="4.5,-2.8!"]
  ...
  help_event_property_property_out [shape="point", pos="2.3,-1.4!", label="", height=0.0, width=0.0]
  ...
  characteristic_west1 [shape="point", pos="2.9,-1.1!", label="", height=0.0, width=0.0]
  property_east1 -> characteristic_west1 [dir="both", arrowhead="none", arrowtail="ediamond", headlabel="1"]

  // Trait --|> Characteristic
  trait_south1 [shape="point", pos="3.5,-0.33!", label="", height=0.0, width=0.0]
  characteristic_north1 [shape="point", pos="3.5,-0.93!", label="", height=0.0, width=0.0]
  trait_south1 -> characteristic_north1 [arrowhead="empty"]

  // Trait --[baseCharacteristic]--> Characteristic
  trait_south2 [shape="point", pos="5.5,-0.33!", label="", height=0.0, width=0.0]
  characteristic_north2 [shape="point", pos="5.5,-0.93!", label="", height=0.0, width=0.0]
  trait_south2 -> characteristic_north2 [dir="both", arrowhead="none", arrowtail="ediamond", headlabel="1"]

  // Trait --[constraint]--> Constraint
  trait_west1 [shape="point", pos="2.9,-0.05!", label="", height=0.0, width=0.0]
  help19 [shape="point", pos="2.6,-0.05!", label="", height=0.0, width=0.0]
  constraint_west1 [shape="point", pos="2.9,0.7!", label="", height=0.0, width=0.0]
  help20 [shape="point", pos="2.6,0.7!", label="", height=0.0, width=0.0]
  ...
  property_east2 [shape="point", pos="1.6,-1.7!", label="", height=0.0, width=0.0]
  help13 [shape="point", pos="2.0,-1.7!", label="", height=0.0, width=0.0]
  entity_east1 [shape="point", pos="1.6,-2.9!", label="", height=0.0, width=0.0]
  help14 [shape="point", pos="2.0,-2.9!", label="", height=0.0, width=0.0]
  ...
  characteristic_label [label="characteristic", pos="2.3,-1.1!", color="white", fillcolor="white", fontsize=9, shape="box", width=0.8, height=0.2, fixedsize=true]
  ...
  properties_label2 [label="properties", pos="1.9,-2.15!", color="white", fillcolor="white", fontsize=9, shape="box", width=0.5, height=0.2, fixedsize=true]
  ...
  constraint_label [label="constraint", pos="2.5,0.35!", color="white", fillcolor="white", fontsize=9, shape="box", width="0.7", height="0.2", fixedsize=true]
